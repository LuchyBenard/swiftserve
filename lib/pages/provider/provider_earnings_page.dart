...
class _ProviderEarningsPageState extends State<ProviderEarningsPage> {
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Row(
                                children: [
                                  _buildTimeToggle("Week", true),
                                  _buildTimeToggle("Month", false),
                                ],
                              ),
                            ),
                          ],
                        ...
                        const SizedBox(height: 16),
                        _buildTransactionItem("Haircut & Beard Trim", "David Miller", "2 hours ago", "+\$45.00", Icons.content_cut),
                        _buildTransactionItem("Sink Repair", "Sarah Jenkins", "Yesterday", "+\$120.00", Icons.plumbing),
                        _buildTransactionItem("Premium Fade", "Mike Ross", "Yesterday", "+\$35.00", Icons.content_cut),
                        _buildTransactionItem("Wiring Fix", "Alex Chen", "Oct 24", "+\$85.00", Icons.electrical_services),
  ...
  Widget _buildBalanceCard() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFF141E18).withOpacity(0.6),
    ...
    return SizedBox(
      ...
      child: Row(
        ...
        children: List.generate(7, (index) {
          bool isHighlight = index == 4; // Friday
          return Column(
            ...
            children: [
              if (isHighlight)
                Container(
                  ...
                  child: const Text("\$450", style: TextStyle(color: Colors.black, fontSize: 10, fontWeight: FontWeight.bold)),
                ),
              Container(
                width: 40,
                height: 120 * _weeklyData[index],
                decoration: BoxDecoration(
                  color: isHighlight ? primaryGreen : primaryGreen.withOpacity(0.2),
                  borderRadius: BorderRadius.circular(8),
